...
// IMPORTANT: Vite may convert "0.0.7415266" to scientific notation - always use string literal
// Created: 2025-12-10 - Topic for Ez Crypto Tips Reviews Storage (Public Submissions)
// NOTE: No submitKey - allows any user to submit reviews without INVALID_SIGNATURE error
const REVIEWS_TOPIC_ID = '0.0.7415266';
